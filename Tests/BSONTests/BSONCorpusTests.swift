...
final class BSONCorpusTests: XCTestCase {
    func testTopLevel() {
        ...
        XCTAssertFalse(Document(bytes: [0x01,0x00,0x00,0x00,0x00]).validate().isValid)
        XCTAssertFalse(Document(bytes: [0x04,0x00,0x00,0x00,0x00]).validate().isValid)
        XCTAssertFalse(Document(bytes: [0x05,0x00,0x00,0x00]).validate().isValid)
        XCTAssertFalse(Document(bytes: [0x05,0x00,0x00,0x00,0x01]).validate().isValid)
        XCTAssertFalse(Document(bytes: [0x05,0x00,0x00,0x00,0xFF]).validate().isValid)
        XCTAssertFalse(Document(bytes: [0x05,0x00,0x00,0x00,0x70]).validate().isValid)
        XCTAssertFalse(Document(bytes: [0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00]).validate().isValid)
        XCTAssertFalse(Document(bytes: [0x12,0x00,0x00,0x00,0x02,0x66,0x6F,0x6F,0x00,0x04,0x00,0x00,0x00,0x62,0x61,0x72]).validate().isValid)
        XCTAssertFalse(Document(bytes: [0x12,0x00,0x00,0x00,0x02,0x66,0x6F,0x6F,0x00,0x04,0x00,0x00,0x00,0x62,0x61,0x72,0x00,0x00,0xDE,0xAD,0xBE,0xEF]).validate().isValid)
        XCTAssertFalse(Document(bytes: [0x13,0x00,0x00,0x00,0x02,0x66,0x6F,0x6F,0x00,0x04,0x00,0x00,0x00,0x62,0x61,0x72,0x00,0x00]).validate().isValid)
        XCTAssertFalse(Document(bytes: [0x11,0x00,0x00,0x00,0x02,0x66,0x6F,0x6F,0x00,0x04,0x00,0x00,0x00,0x62,0x61,0x72,0x00,0x00]).validate().isValid)
        XCTAssertFalse(Document(bytes: [0x07,0x00,0x00,0x00,0x00,0x00,0x00]).validate().isValid)
        XCTAssertFalse(Document(bytes: [0x07,0x00,0x00,0x00,0x80,0x00,0x00]).validate().isValid)
        XCTAssertFalse(Document(bytes: [0x12,0x00,0x00,0x00,0x02,0x66,0x6F]).validate().isValid)
    }
//
//    func testTimestamp() {
